				...
				m: &fake.Manager{
					Client: &test.MockClient{
						...
						MockStatusUpdate: test.MockSubResourceUpdateFn(func(_ context.Context, obj client.Object, _ ...client.SubResourceUpdateOption) error {
							...
							want.SetConditions(xpv2.ReconcilePaused().WithObservedGeneration(42).WithMessage("External resource differs from desired state, but will not update: mock diff"))
