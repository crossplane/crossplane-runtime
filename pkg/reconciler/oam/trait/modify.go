...
func (m *WorkloadModifier) Modify(ctx context.Context, obj runtime.Object, t resource.Trait) error {
...
func NewWorkloadModifierWithAccessor(m ModifyFn, a ModifyAccessor) Modifier {
	return &WorkloadModifier{
		ModifyFn: func(ctx context.Context, obj runtime.Object, t resource.Trait) error { return a(ctx, obj, t, m) },
	}
}
