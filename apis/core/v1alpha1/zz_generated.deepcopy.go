...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CompositionPatch) DeepCopyInto(out *CompositionPatch) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CompositionPatch.
func (in *CompositionPatch) DeepCopy() *CompositionPatch {
	if in == nil {
		return nil
	}
	out := new(CompositionPatch)
	in.DeepCopyInto(out)
	return out
}
