...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternalStoreConfig) DeepCopyInto(out *ExternalStoreConfig) {
	*out = *in
	if in.ConfigRef != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalStoreConfig.
func (in *ExternalStoreConfig) DeepCopy() *ExternalStoreConfig {
	if in == nil {
		return nil
	}
	out := new(ExternalStoreConfig)
	in.DeepCopyInto(out)
	return out
}
