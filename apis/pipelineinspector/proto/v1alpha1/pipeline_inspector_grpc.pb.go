...
func (c *pipelineInspectorServiceClient) EmitRequest(ctx context.Context, in *EmitRequestRequest, opts ...grpc.CallOption) (*EmitRequestResponse, error) {
	...
	err := c.cc.Invoke(ctx, PipelineInspectorService_EmitRequest_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pipelineInspectorServiceClient) EmitResponse(ctx context.Context, in *EmitResponseRequest, opts ...grpc.CallOption) (*EmitResponseResponse, error) {
	...
	err := c.cc.Invoke(ctx, PipelineInspectorService_EmitResponse_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPipelineInspectorServiceServer must be embedded to have forward compatible implementations.
...
var PipelineInspectorService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pipelineinspector/proto/v1alpha1/pipeline_inspector.proto",
}
